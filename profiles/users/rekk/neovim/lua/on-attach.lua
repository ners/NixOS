...
local function on_attach(client, buffer)
	...
	vim.api.nvim_buf_set_keymap(buffer, 'n', 'gd', '<cmd>lua vim.lsp.buf.definition()<CR>', keymapOpts)
	vim.api.nvim_buf_set_keymap(buffer, 'n', 'gr', '<cmd>lua vim.lsp.buf.references()<CR>', keymapOpts)
	...
	-- vim.api.nvim_buf_set_keymap(buffer, 'n', '`', '<cmd>lua vim.lsp.buf.hover()<CR>', opts)
	...
	vim.api.nvim_buf_set_keymap(buffer, 'n', '<space>f', '<cmd>lua vim.lsp.buf.formatting()<CR>', keymapOpts)
    -- --
